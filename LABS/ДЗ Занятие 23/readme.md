...
#### [Результат выполнения команды show spanning-tree interface f0/18 detail на S2](ShSp21)
### Шаг 7. Проверьте наличие сквозного ⁪подключения.
#### Проверка доступности IP-адреса ПК PC-A с ПК PC-B, выполнение команды ping:
![](ping1.png)
