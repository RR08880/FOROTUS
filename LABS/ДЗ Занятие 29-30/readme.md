...
######     60 permit ip any any
#### Выполнение проверки.
##### С PC-A (который в сети Operations IP: 10.30.0.10/24) невозможно подключиться по SSH к R1 по IP-адресам всех интерфейсов (10.20.0.1, 10.30.0.1, 10.40.0.1, 172.16.1.1). Подключение возможно только по IP-адресу инт. loopback 1: 10.10.10.1.
