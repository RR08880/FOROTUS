...
#### Исключение по 5 первых адресов из подсетей 192.168.1.0/26 и 192.168.1.96/28:
###### ip dhcp excluded-address 192.168.1.1 192.168.1.5
###### ip dhcp excluded-address 192.168.1.97 192.168.1.101
#### Настройка пула R1-Client-LAN для vlan 100:
...
#### Проверка созданных пулов адресов:
