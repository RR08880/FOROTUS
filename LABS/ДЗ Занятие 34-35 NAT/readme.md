...
##### d.	Теперь запускаем пинг R2 Lo1 из S2. На этот раз перевод завершается неудачей, т.к. в созданном пуле PUBLIC_ACCESS всего 3 адреса для NAT трансляций, см. следующий пнкт "е".
