...
##### a.	Проверка добавления статической записи выполнением команды show ip nat translations на R1:
![](shipnattrR1-6.png)
##### b.	Проверьтка выполнением команды ping  с R2 на 209.165.200.229. Эхо-запросы и ответы проходят успешно.
##### c.	Отображение таблицы NAT-трансляций на R1 с помощью команды show ip nat translations:
![](shipnattrR1-7.png)
##### В выводе также присутствует запись о статическом NAT преобразовании.
