...
###### Выполнение команды ip ospf dead-interval 120 на обоих маршрутизаторах в режиме конфигурации интерфейса G0/0/1. Для установки значения этого параметра равного 4-х кратному значению hello-interval (30).
...
#### a. Выполнение команды show ip ospf interface g0/0/1 на R2:
#### [Результат выполнения на R2](shipintR13)
#### b.	На R1 выполните команду show ip route ospf, чтобы убедиться, что сеть R2 Loopback1 присутствует в таблице маршрутизации. Обратите внимание на разницу в метрике между этим выходным и предыдущим выходным. Также обратите внимание, что маска теперь составляет 24 бита, в отличие от 32 битов, ранее объявленных.
###### R1#sh ip route ospf
###### O    192.168.1.0 [110/2] via 10.53.0.2, 00:09:37, GigabitEthernet0/0/1
##### Маршрут до подсети 192.168.1.0 присутствует и получен по OSPF.
#### c.	Введите команду show ip route ospf на маршрутизаторе R2. Единственная информация о маршруте OSPF должна быть распространяемый по умолчанию маршрут R1.
###### R2#sh ip route ospf
###### O*E2 0.0.0.0/0 [110/1] via 10.53.0.1, 00:12:25, GigabitEthernet0/0/1
##### Маршрут по умолчанию присутствует и получен по OSPF.
...
###### Стоимость для маршрута по умолчанию всегда имеет наименьшую величину.
