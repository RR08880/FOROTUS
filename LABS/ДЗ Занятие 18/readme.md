...
##### Почему протокол spanning-tree выбрал этот порт в качестве невыделенного (заблокированного) порта? В текущей топологии только один из коммутаторов S1 или S2 может содержать заблокированный порт.
#####  BID на всех коммутаторах одинаковые. Сравниваются MAC адреса, на S1 самое большое значение MAC адреса-порт F0/2 блокируется на его стороне.
