...
##### В выводе выполнения команды show clock detail присутствует информации об источнике настройки времени: Time source is user configuration
##### Т.е. время и дата установлены ручной настройкой.
![](cl1.png)
