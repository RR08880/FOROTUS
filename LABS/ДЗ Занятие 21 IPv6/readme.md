...
![](ProvPCB1.png)
### DNS-суффикс получен, адрес DNS сервера получен, получен IPv6-адрес из заданного в настройках диапазона 2001:db8:acad:3:aaa::/80
#### Проверга доступности инт. G0/0/1 R1  комндой пинг с PC-B:
![](ProvPCB2.png)
